...
#define ADD(DestReg, SourceReg2, SourceReg1) (OP_ALU << 28) | (OP_ADD << 25) |(SourceReg2 << 20) | (SourceReg1 << 5) | DestReg

#define SUB(DestReg, SourceReg2, SourceReg1) (OP_ALU << 28) | (OP_SUB << 25) |(SourceReg2 << 20) | (SourceReg1 << 5) | DestReg

#define AND(DestReg, SourceReg2, SourceReg1) (OP_ALU << 28) | (OP_AND << 25) |(SourceReg2 << 20) | (SourceReg1 << 5) | DestReg

#define OR(DestReg, SourceReg2, SourceReg1) (OP_ALU << 28) | (OP_OR << 25) |(SourceReg2 << 20) | (SourceReg1 << 5) | DestReg

#define XOR(DestReg, SourceReg2, SourceReg1) (OP_ALU << 28) | (OP_XOR << 25) |(SourceReg2 << 20) | (SourceReg1 << 5) | DestReg
...
#define CBZ(DestReg,SourceReg1) (OP_CBZ << 28) | (SourceReg1 << 5) | DestReg
...
SUB(W4,W2,W0),
    ...
    //CBZ(W4,W3), CBZ CAUSING INFINITE LOOP :(
AND(W6,W4,W3),
OR(W7,W4,W3),
STW(W6,0,0), // 3
ADD(W7,W1,W3),
